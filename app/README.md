...
command "google" will search the word you typed,

command "I want to eat" will give you a random restaurant,

command "Exit Ticket" will give you the Exit Ticket for GA Course
